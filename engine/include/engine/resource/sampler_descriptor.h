...
#ifndef ASTERACITY_ENGINE_RESOURCE_SAMPLER_DESCRIPTOR_H
#define ASTERACITY_ENGINE_RESOURCE_SAMPLER_DESCRIPTOR_H
...
#endif //ASTERACITY_ENGINE_RESOURCE_SAMPLER_DESCRIPTOR_H
