...
#ifndef ASTERACITY_ENGINE_RESOURCE_RESOURCE_MANAGER_H
#define ASTERACITY_ENGINE_RESOURCE_RESOURCE_MANAGER_H
...
#endif //ASTERACITY_ENGINE_RESOURCE_RESOURCE_MANAGER_H
