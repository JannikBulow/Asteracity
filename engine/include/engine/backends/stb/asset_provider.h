...
#ifndef ASTERACITY_ENGINE_BACKENDS_STB_ASSET_PROVIDER_H
#define ASTERACITY_ENGINE_BACKENDS_STB_ASSET_PROVIDER_H
...
#endif //ASTERACITY_ENGINE_BACKENDS_STB_ASSET_PROVIDER_H
