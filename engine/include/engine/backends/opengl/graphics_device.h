...
#ifndef ASTERACITY_ENGINE_BACKENDS_OPENGL_GRAPHICS_DEVICE_H
#define ASTERACITY_ENGINE_BACKENDS_OPENGL_GRAPHICS_DEVICE_H
...
#endif //ASTERACITY_ENGINE_BACKENDS_OPENGL_GRAPHICS_DEVICE_H
