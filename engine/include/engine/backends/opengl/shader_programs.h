...
#ifndef ASTERACITY_ENGINE_BACKENDS_OPENGL_SHADER_PROGRAMS_H
#define ASTERACITY_ENGINE_BACKENDS_OPENGL_SHADER_PROGRAMS_H
...
#endif //ASTERACITY_ENGINE_BACKENDS_OPENGL_SHADER_PROGRAMS_H
