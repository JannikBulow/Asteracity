...
#ifndef ASTERACITY_ENGINE_BACKENDS_MINIAUDIO_AUDIO_DEVICE_H
#define ASTERACITY_ENGINE_BACKENDS_MINIAUDIO_AUDIO_DEVICE_H
...
#endif //ASTERACITY_ENGINE_BACKENDS_MINIAUDIO_AUDIO_DEVICE_H
